...
function ProductDetailPage() {
  ...
  const { data: product, loading } = useRequest(() => serviceGetProductDetail(id), {
    refreshDeps: [id],
  });
        ...
        {product?.data.length > 0 && (
          ...
          >
              ...
              <div className={clsx(styles.right)}>
                ...
                <div className={'flex gap-4 flex-wrap'}>
                  ...
                  <button
                    onClick={() => {
                      return (
                        handleAddCart(), user?.isAuthenticated && navigate(ROUTE_PATH.CHECKOUT)
                      );
                    }}
            ...
            <div
              className={clsx(
                styles.describe,
                'max-w-[1170px] py-[30px] border-y border-[#dcdcdc]',
              )}
            >
